...
RESTORE_PATH = "/home/dhiya/Research/repositories/TTS/YourTTS-EN-VCTK-Testing/best_model_scl_latest.pth"
...
UCV_DOWNLOAD_PATH = os.path.join(CURRENT_PATH, "UncommonVoice")
...
ucv_config = BaseDatasetConfig(
    formatter="uncommon_voice",
    dataset_name="uncommon_voice",
    meta_file_train="",
    meta_file_val="",
    path=UCV_DOWNLOAD_PATH,
    language="en",
    ignored_speakers=["FD015", "FD046", "MD09"],
)
...
DATASETS_CONFIG_LIST = [vctk_config, ucv_config]
